...
The store holds the state and it is the only place your app will be getting state. Actions handle axios and sends dispatches to the reducer which changes the state when told.
...
I like Redux because once its all setup, dispatching actions and state management becomes a lot more manageable in full scale applications.
